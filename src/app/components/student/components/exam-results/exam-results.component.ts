...
export class ExamResultsComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.rowData = this.rowData = [
      { position: 1, course: 'Sanskrit', marks: 94, totalmarks: 100, pub_date: '17/03/2022' },
      { position: 2, course: 'English', marks: 82, totalmarks: 100, pub_date: '17/03/2022' },
      { position: 3, course: 'Hindi', marks: 79, totalmarks: 100, pub_date: '17/03/2022' },
      { position: 4, course: 'Science', marks: 98, totalmarks: 100, pub_date: '17/03/2022' },
      { position: 5, course: 'Social Science', marks: 92, totalmarks: 100, pub_date: '17/03/2022' },
    ];
